...
/**
 * Servlet implementation class DeshabilitarProveedor
 */
@WebServlet("/DeshabilitarProveedor")
public class DeshabilitarProveedor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeshabilitarProveedor() {
        super();
