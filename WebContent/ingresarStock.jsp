        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto ">
              ...
              <form action="IngresarStock" method="post" enctype="multipart/form-data">

                <div class="form-label-group">
                  <input type="number" name="idProd" id="idProd" class="form-control" placeholder="ID del producto" required >
